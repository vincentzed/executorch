...
class Lfm2p5Vl(torch.nn.Module):
    ...
    def _patch_positional_embeddings(self) -> None:
        ...
        embeddings_module = self.model_.model.vision_tower.vision_model.embeddings
        embeddings_module.register_buffer("_precomputed_pe", precomputed_pe, persistent=False)

        def _patched_resize(positional_embeddings, height=None, width=None, max_length=None):
            return embeddings_module._precomputed_pe

        embeddings_module.resize_positional_embeddings = _patched_resize
